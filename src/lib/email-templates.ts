...
export function buildTeamInviteEmail(companyName: string, inviterName: string, inviteUrl: string): string {
  return `<!DOCTYPE html>
<html>
    ...
    <tr><td>
      ...
      <div style="background:#fff;padding:32px;border-radius:0 0 16px 16px;border:1px solid #e2e8f0;border-top:none;">
        <h1 style="margin:0 0 12px;font-size:22px;font-weight:900;color:#0f172a;line-height:1.2;">
          Join ${companyName} on Trust Cabbage
        </h1>
        <p style="margin:0 0 24px;color:#64748b;font-size:15px;line-height:1.6;">
          ${inviterName} invited you to help manage <strong>${companyName}</strong>&apos;s dashboard, reviews, and Service Desk on Trust Cabbage.
        </p>
        ...
        <p style="margin:0;color:#94a3b8;font-size:12px;line-height:1.5;">
          You received this because ${inviterName} invited this email address to join ${companyName}&apos;s team on Trust Cabbage.
